...
- 판정: 실패
- 실행 폴더: examples/agent_loop_runs/BTC_USDT_20260412_155742/runs/BTC_USDT_20260412_155805
- 데이터 설정: CCXT, 거래소 binance, BTC/USDT, 5m, 기간 180d
- 구간 설정: train 30일 / validation 10일 / test 10일, split 2개
- 전략 설정: MA crossover, window `6,12,18,24,30,90,96,102,108`, 선택 기준 `총수익률`, 후보 3개, 최소 거래 1회
- 변경 설명: MA 탐색 구간을 `6,12,18,24,30,90,96,102`에서 `6,12,18,24,30,90,96,102,108`로 바꿨습니다.
- 핵심 지표: 테스트 중앙값 -0.013, 플러스 비율 50.0%, 홀드 초과 비율 0.0%
