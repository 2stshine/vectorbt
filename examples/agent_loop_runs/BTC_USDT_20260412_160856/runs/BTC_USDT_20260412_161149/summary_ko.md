...
- 판정: 실패
- 실행 폴더: examples/agent_loop_runs/BTC_USDT_20260412_160856/runs/BTC_USDT_20260412_161149
...
- 보조 지표: 평균 테스트 수익률 -2.16%, 평균 홀드 수익률 2.64%, 평균 테스트 낙폭 6.42%
- 선택된 파라미터: [[96, 144], [36, 144], [18, 144], [36, 96], [48, 96]]
- 해석: 선택된 테스트 구간을 시간순으로 이어 보면 전략 누적 수익률이 -12.76%로 홀드 15.80%보다 낮았습니다.
...
- 실패/판정 이유: 평균 테스트 수익률이 -2.16%로 기준 0.00%보다 낮았습니다.
