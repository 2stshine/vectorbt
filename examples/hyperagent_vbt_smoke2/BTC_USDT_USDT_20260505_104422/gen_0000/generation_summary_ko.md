...
- 가설: 초기 세대에서는 `ma_crossover_ls` 패밀리로 기준선을 잡고 이후 세대가 여기서 분기합니다.
- 제안 이유: 첫 세대의 seed 전략을 평가해 이후 세대가 비교할 출발점을 만듭니다.
...
- 전략 메모: seed 패밀리: ma_crossover_ls
- 백테스트 요약: [summary_ko.md](gen_0000/full_runs/BTC_USDT_USDT_20260505_104443/summary_ko.md)

## 시각화

### 홀드 비교
![홀드 비교](gen_0000/full_runs/BTC_USDT_USDT_20260505_104443/plots/hold_comparison.png)

### 수익률 타임라인
![수익률 타임라인](gen_0000/full_runs/BTC_USDT_USDT_20260505_104443/plots/return_timeline.png)

### 오버피팅 타임라인
![오버피팅 타임라인](gen_0000/full_runs/BTC_USDT_USDT_20260505_104443/plots/overfitting_timeline.png)
