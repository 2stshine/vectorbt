...
- 판정: 실패
- 실행 폴더: examples/hyperagent_vbt_smoke2/BTC_USDT_USDT_20260505_104422/gen_0000/full_runs/BTC_USDT_USDT_20260505_104443
...
- 전략 설정: family `ma_crossover_ls`, 방향 `both`, 선택 기준 `총수익률`, 후보 8개, 최소 거래 1회
...
- 핵심 지표: 테스트 중앙값 -0.017, 플러스 비율 50.0%, Long Hold 초과 비율 0.0%
- 보조 지표: 평균 테스트 수익률 -1.65%, 평균 Long Hold 수익률 5.34%, 평균 테스트 낙폭 7.41%
- 선택된 후보: ['ma_crossover_ls: fast_window=6, slow_window=72', 'ma_crossover_ls: fast_window=36, slow_window=144']
- 해석: 선택된 테스트 구간을 시간순으로 이어 보면 전략 누적 수익률이 -3.34%로 홀드 10.97%보다 낮았습니다.
